...
std::string NormalizeTransformation::getTestCaseName(testing::TestParamInfo<NormalizeTransformationParams> obj) {
    ...
    bool fuseMultiply;
    std::tie(netPrecision, inputShapes, targetDevice, params, fuseMultiply) = obj.param;
...
void NormalizeTransformation::SetUp() {
    ...
    InferenceEngine::details::LayerTransformation::Params params;
    bool fuseMultiply;
    std::tie(netPrecision, inputShape, targetDevice, params, fuseMultiply) = this->GetParam();
