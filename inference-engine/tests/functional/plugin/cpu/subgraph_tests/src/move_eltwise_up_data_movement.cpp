...
TEST(MoveEltwiseUpThroughDataMovFixture, MoveEltwiseUpThroughDataMov) {
...
TEST(DISABLED_MoveEltwiseUpThroughDataMovFixture, EltwiseSequence) {
    ...
    auto res = compare_functions(f, f_ref);
    {
        ngraph::pass::VisualizeTree("/home/user/work/f.svg").run_on_function(f);
        ngraph::pass::VisualizeTree("/home/user/work/f_ref.svg").run_on_function(f_ref);
    }
